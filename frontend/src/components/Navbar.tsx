            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className={`px-4 py-2 rounded-xl font-mono text-[10px] uppercase tracking-[0.1em] transition-colors ${
                  isTransparent ? 'text-forest/70 hover:text-forest' : 'text-sage hover:text-[#E8DECE]'
                }`}
              >
                How it works
              </button>
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-xl font-mono text-[10px] uppercase tracking-[0.1em] transition-all duration-200 ${
                  isTransparent
                    ? 'bg-forest text-[#E8DECE] hover:bg-forest/80'
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="relative ml-3" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold bg-gold text-forest hover:bg-gold/90 transition-all duration-200"
                >
                  + New Trip
                  <svg
